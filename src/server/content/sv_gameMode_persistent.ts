...
import { MATCHMAKE_PLAYERCOUNT_STARTSERVER, SH_GAMEMODE_PERSISTENT_MINPLAYERS, SPAWN_ROOM } from "shared/sh_settings"
...
export function SV_GameMode_PersistentSetup()
{
   ...
   gmc.MATCHMAKE_PLAYERCOUNT_MINPLAYERS = SH_GAMEMODE_PERSISTENT_MINPLAYERS
